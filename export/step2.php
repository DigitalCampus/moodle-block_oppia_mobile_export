...
$keephtml = optional_param('keep_html', false, PARAM_BOOL);
$videooverlay = optional_param('video_overlay', false, PARAM_BOOL);
...
add_or_update_oppiaconfig($id, 'keep_html', $keephtml, $server);
add_or_update_oppiaconfig($id, 'video_overlay', $videooverlay, $server);

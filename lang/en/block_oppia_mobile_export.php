...
$string['export_quizzes_nor_feedback_message'] = 'This course does not have any quiz or feedback activities. Please, click the continue button to move to the next step.';
